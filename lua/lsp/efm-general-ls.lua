...
local vue_args = {}
if O.vue.formatter == 'prettier' then table.insert(vue_args, prettier) end

if O.vue.linter == 'eslint' then table.insert(vue_args, eslint) end

local goimports = {formatCommand = DATA_PATH .. '/lspinstall/go/goimports', formatStdin = true}
-- local markdownlint = {
...
require"lspconfig".efm.setup {
    ...
    cmd = {DATA_PATH .. "/lspinstall/efm/efm-langserver", '-logfile', '/tmp/efm.log', '-loglevel', '1'},
